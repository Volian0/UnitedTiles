...
m_font2{game->renderer.get(), "robotoc.ttf", 3.0L},
m_text{game->renderer.get(), &m_font, "v1.0.2 by Gabriel \"Volian0\" Hinca", Colors::BLACK},
m_text2{game->renderer.get(), &m_font2, "Additional songs by JKen777, NathanTalksTech, tastyForReal", Colors::GRAY},
